...
WEBCACHE_CLASSPATH=$WEBCACHE_CLASSPATH:$HADOOP_CLASSPATH
$JAVA_HOME/bin/java -Xms8G -Xmx8G -classpath $WEBCACHE_CLASSPATH com.oneboxtech.se.webcache.client.DumpData $1